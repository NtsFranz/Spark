...
<div class="container">
    <div class="top_row">
        ...
        <div id="team_name_orange" class="team_name orange">{config ? config['teams'][1]['team_name'] : ''}</div>
        <img id="team_logo_orange" class="team_logo orange"
             src="{config ? config['teams'][1]['team_logo'] : 'data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAQAAAC1HAwCAAAAC0lEQVR42mNkYAAAAAYAAjCB0C8AAAAASUVORK5CYII='}"
             alt="">
        <div id="orange_joust" class="joust orange" class:visible={orangeJoustVisible}><span>{orangeJoustText}</span>
        </div>

        <div id="team_name_blue" class="team_name blue">{config ? config['teams'][0]['team_name'] : ''}</div>
        <img id="team_logo_blue" class="team_logo blue"
             src="{config ? config['teams'][0]['team_logo'] : 'data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAQAAAC1HAwCAAAAC0lEQVR42mNkYAAAAAYAAjCB0C8AAAAASUVORK5CYII='}"
             alt="">
        <div id="blue_joust" class="joust blue" class:visible={blueJoustVisible}><span>{blueJoustText}</span></div>
