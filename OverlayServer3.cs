...
namespace Spark
{
	public class OverlayServer3
	{
		private WebServer2 webServer2;

		public OverlayServer3()
		{
		...
		private string HandleRequest(HttpListenerRequest request)
		{
			...
			return "test interesttingg.g.g.g";
		}
...
// 			{
// 				return Program.inGame ? Program.lastJSON : null;
// 			}
// 			
