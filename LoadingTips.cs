namespace Spark
{
	public class LoadingTips
	{
		public static string[] newTips =
		{
			...
			"Log into Spark with Discord to enable features like uploading stats to metrics.ignitevr.gg and TTS.",
			...
			"You can change many of Echo VR's ingame settings from within Spark's settings.",
			...
			"You can automatically upload your tablet stats and view them on metrics.ignitevr.gg.",
			...
			"You can set up the in-game emote gesture to activate clips with Spark!",
