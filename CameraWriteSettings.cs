...
namespace Spark
{
	class CameraWriteSettings
	{
		...
		public Dictionary<string, CameraTransform> waypointPositions { get; } = new Dictionary<string, CameraTransform>();
		public List<CameraTransform> keyframePositions { get; } = new List<CameraTransform>();
